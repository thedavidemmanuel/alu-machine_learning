...
class NST:
    ...
    def generate_features(self):
        ...
        self.gram_style_features = [self.gram_matrix(style_feature) for style_feature in style_features[:-1]]
    ...
    def layer_style_cost(self, style_output, gram_target):
        ...
        if not isinstance(gram_target, (tf.Tensor, tf.Variable)) or gram_target.ndim != 3:
            raise TypeError("gram_target must be a tensor of rank 3")
        
        style_output_shape = style_output.shape
    ...
    def style_cost(self, style_outputs):
        ...
        return tf.reduce_sum(style_costs)